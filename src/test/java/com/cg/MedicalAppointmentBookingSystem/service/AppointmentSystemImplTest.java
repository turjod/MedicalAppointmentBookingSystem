...
class AppointmentSystemImplTest {
...
//      System.setErr(new PrintStream(outContent));
  ...
  public void testRegisterPatient_Pass() {
      Patient patient = new Patient("P003", "A man");
      appointmentSystem.registerPatient(patient);
      assertTrue(appointmentSystem.getPatients().contains(patient));
  }
  
  
  @Test
  public void testRegisterPatient_Fail() {
      Patient patient = new Patient("P008", "A man");
      assertFalse(appointmentSystem.getPatients().contains(patient));
  }
  ...
  public void testRegisterDoctor_Pass() {
      Doctor doctor = new Doctor("D001", "Dr. Faustus");
      appointmentSystem.registerDoctor(doctor);
      assertTrue(appointmentSystem.getDoctors().contains(doctor));
  }

  @Test
  public void testRegisterDoctor_Fail() {
      Doctor doctor = new Doctor("D001", "Dr. Faustus");
      assertFalse(appointmentSystem.getDoctors().contains(doctor));
  }
  ...
  public void testBookAppointment_Pass() {
      ...
      assertTrue(appointment.getStatus().equals("Scheduled"));
  }
  ...
  public void testBookAppointment_Fail_With_Null() {
      Patient patient = null;
      //Appointment appointment = appointmentSystem.bookAppointment(patient);
      assertThrows(InvalidAppointmentException.class, ()->appointmentSystem.bookAppointment(patient));
  }
  ...
  @Test
  public void testCompleteAppointment_Invalid_Index() {
      assertThrows(InvalidAppointmentException.class, ()->appointmentSystem.completeAppointment(-1));
  }
...
//      appointmentSystem.completeAppointment(0);
  ...
  public void showAllPatients_Pass() {
      appointmentSystem.showAllPatients();
      assertEquals(3, appointmentSystem.getPatients().size());
  }

  @Test
  public void showAllPatients_Fail() {
      appointmentSystem.getPatients().clear();
      assertThrows(EmptyValueException.class, ()->appointmentSystem.showAllPatients());
  }

  @Test
  public void showAllDoctors() {
      appointmentSystem.showAllDoctors();
      assertEquals(3, appointmentSystem.getDoctors().size());
  }

  @Test
  public void showAllDoctors_Fail() {
      appointmentSystem.getDoctors().clear();
      assertThrows(EmptyValueException.class, ()->appointmentSystem.showAllDoctors());
  }

  @Test
  public void showAllAppointments() {
      appointmentSystem.showAllAppointments();
      assertEquals(2, appointmentSystem.getAppointments().size());
  }

  @Test
  public void showAllAppointments_Fail() {
      appointmentSystem.getAppointments().clear();
      assertThrows(EmptyValueException.class, ()->appointmentSystem.showAllAppointments());
  }
